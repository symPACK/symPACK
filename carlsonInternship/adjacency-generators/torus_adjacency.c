    ...
    for (int i = 0; i < (height * width); i ++) {
        ...
        if (op >= 7) {
        	if (i == bottomRowStart) {
        		...
        		tempArray[tempArrayIndex] = (height*width);
//        		leftEdge += width;
...
//        		leftEdge += width;
        ...
        if (i >= bottomRowStart && i <= bottomRowEnd) {
        	//Do Bottom row
        	tempArray[tempArrayIndex] = i + 1 + (width * (height - 1));
        } else {
        	tempArray[tempArrayIndex] = i + 1 - width;
        }
        tempArrayIndex += 1;
        ...
        if (op == 9) {
        	if (i == bottomRowEnd) {
        		tempArray[tempArrayIndex] = 1+ width * (height - 1);
        	} else if ((bottomRowStart <= i) && (bottomRowEnd > i)) {
        		tempArray[tempArrayIndex] = i + (width * (height - 1)) + 2;
        	} else if (i == rightEdge) {
        		tempArray[tempArrayIndex] = i - (2*width) + 2;
        	} else {
        		tempArray[tempArrayIndex] = i - width + 2;
        	}
        	tempArrayIndex += 1;
        }
        ...
        if (op == 9) {
        	if (i == topRowStart) {
        		tempArray[tempArrayIndex] = width;
        	} else if ((i > topRowStart) && (i <= topRowEnd)) {
        		tempArray[tempArrayIndex] = i - (width * (height - 1));
        	} else if (i == leftEdge) {
        		tempArray[tempArrayIndex] = i + (2*width);
        	} else {
        		tempArray[tempArrayIndex] = i + width;
        	}
        	tempArrayIndex += 1;
