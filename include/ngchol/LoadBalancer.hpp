...
class SubtreeToSubcube: public LoadBalancer{
  public:
      class ProcGroup{
        protected:
        vector<Int> ranks_;
  ...
  public:
      SubtreeToSubcube(Int np, ETree & supETree,IntNumVec & Xsuper, IntNumVec & SupMembership,PtrVec & Xlindx, IdxVec & Lindx, IntNumVec & pCc, bool fan_in = true):Xsuper_(Xsuper),SupMembership_(SupMembership),cc_(pCc),Xlindx_(Xlindx),Lindx_(Lindx),LoadBalancer(np,supETree.Size()){
          supETree_ = supETree;
          fan_in_=fan_in;
...
class SubtreeToSubcubeVolume: public LoadBalancer{
  public:
      class ProcGroup{
        protected:
        vector<Int> ranks_;
  ...
  public:
      SubtreeToSubcubeVolume(Int np, ETree & supETree,IntNumVec & Xsuper, IntNumVec & SupMembership,PtrVec & Xlindx, IdxVec & Lindx, IntNumVec & pCc):Xsuper_(Xsuper),SupMembership_(SupMembership),cc_(pCc),Xlindx_(Xlindx),Lindx_(Lindx),LoadBalancer(np,supETree.Size()){
          supETree_ = supETree;
          groupIdx_.resize(n_+1,0);
      };
