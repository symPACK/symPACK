...
c       ----------------
c
        integer             cost  , d     , i     , i0    , iglobal, 
     &                      j     , j0    , lhead , mincost, mindist, 
     &                      next  , nextj , nodecnt, nnodes2, nxtnod, 
     &                      oldd  , outhead, prev , repnod
C
C***********************************************************************
C
c       ******************************************
...
c       outhead = 1
        ...
        do  i = 1, nnodes
            iglobal = i0 + i
            if  ( rep(iglobal) .eq. iglobal )  then
                outforw(i) = outhead
                if  ( outhead .gt. 0 )  then
                    outback(outhead) = i
                end if
                outhead = i
                outback(i) = 0
