...
set(INTEL_RTL_ROOT $ENV{INTEL_PATH}.$ENV{INTEL_MINOR_VERSION}/compiler CACHE PATH "Folder contains Intel compilers")
...
if(MKL_SDL)
    ...
    message(STATUS "THREADING: " ${MKL_THREADING_LIBRARY})
    ...
    #find_library(MKL_RTL_LIBRARY libiomp5
    #find_library(MKL_RTL_LIBRARY ${MKL_RTL_LIBNAME}
    #    PATHS ${INTEL_RTL_ROOT}/lib/${MKL_ARCH}/)

    #message(STATUS "RTL: " ${MKL_RTL_LIBNAME})
    #message(STATUS "RTL: " ${INTEL_RTL_ROOT}/lib/${MKL_ARCH}/)
    #message(STATUS "RTL: " ${MKL_RTL_LIBRARY})
...
message(STATUS "MINIMAL: " ${MKL_MINIMAL_LIBRARY})
