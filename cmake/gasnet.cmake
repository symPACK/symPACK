...
#MPI_CFLAGS=${MPI_C_COMPILE_FLAGS} MPI_LIBS=${MPI_C_LINK_FLAGS} 
)
else()
ExternalProject_Add(${GASNET_NAME}
  #URL ${GASNET_URL}/${GASNET_GZ}
...
set(GASNET_DEFINES ${GASNET_DEFINES} "-DGASNET_CONDUIT_ARIES -DGASNET_SEQ -DGASNETT_USE_GCC_ATTRIBUTE_MAYALIAS=1")
